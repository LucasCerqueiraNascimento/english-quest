...
import { Compass, ArrowUpRight, LoaderCircle } from 'lucide-react';
...
export function PublicHeader(){return <header className="public-header"><Brand/><Link className="text-link" href="/teacher/login">Área da professora <ArrowUpRight size={16}/></Link></header>}
